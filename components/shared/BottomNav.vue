...
// 5 tabs per CLAUDE.md §26.1 — order matches the Aura Gas Management
// reference screens (Home/Deliveries/Stock/Customers/Reports).
const items = [
  ...
  { to: '/customers', label: 'Customers', icon: 'groups', roles: [ROLES.ADMIN, ROLES.VIEWER] },
